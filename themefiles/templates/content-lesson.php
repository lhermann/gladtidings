...
// prepare elements
// $badge_order = 			sprintf( '<span class="label label--small">%s %s</span>', __( 'Lesson', 'gladtidings' ), $meta['order_nr'][0] );
$badge_order = 			sprintf( '<span class="label label--small">%s</span>', $meta['order_nr'][0] );
